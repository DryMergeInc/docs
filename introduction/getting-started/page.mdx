...
<Steps>
  ...
  <Step title="Subscribe">
    Click the red "Unsubscribed" button, and subscribe.
...
nodes:
  hello-world.api:
    request:
      ...
      body:
        dry_string:
          message: 'Hello World! (at {{time.body.datetime}})'
    dependencies:
      time:
        id: get-time.api
    get-time.api:
...
1. You can find the configuration language documentation [here](https://drymerge.com/docs/language-reference/overview) to learn more about how to build DryMerge integrations.

2. If you want to see how it's used in practice, we'll do walkthroughs and list examples for more complicated use cases that highlight all the features you can use [here](https://docs.drymerge.com/language-reference/examples).

3. If you want to learn more about the DryMerge CLI, you can find the documentation [here](https://drymerge.com/docs/cli-reference/overview).

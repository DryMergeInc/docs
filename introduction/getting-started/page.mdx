...
1. You can find the configuration language documentation [here](https://docs.drymerge.com/docs/engine-reference/overview) to learn more about how to build DryMerge workflows.

2. If you want to see how it's used in practice, we'll do walkthroughs and list examples for more complicated use cases that highlight all the features you can use [here](https://docs.drymerge.com/emgome-reference/examples).

3. If you want to learn more about the DryMerge CLI, you can find the documentation [here](https://docs.drymerge.com/docs/cli-reference/overview/page).
